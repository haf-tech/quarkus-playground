...
.Helpful links
|===
| Home | link:http://localhost:8080/[]
| Dev UI | link:http://localhost:8080/q/dev/[]
| Health API | link:http://localhost:8080/q/health[]
| Health UI | link:http://localhost:8080/q/health-ui/[]
...
| Secured API with role | link:http://127.0.0.1:8080/secured/datetime[]
|===
